...
# NOTE: This endpoint is deprecated. The /streams/{track_id} endpoint is now handled
# in track_routes.py which gets data from the database and calculates daily_average.
# This file is kept for reference but the router is not actively used.

from fastapi import APIRouter

# Empty router to avoid import errors (endpoint moved to track_routes.py)
router = APIRouter()
